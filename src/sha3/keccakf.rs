...
use crate::sha3::state::A_LEN;

const RC_LEN: usize = 24;

lazy_static! {
    static ref RC: [u64; RC_LEN] = [
        0x0000000000000001,
        0x0000000000008082,
        0x800000000000808A,
        0x8000000080008000,
...
/// keccakf_1600 applies the Keccak permutation to a 1600b-wide
/// state represented as a slice of 25 uint64s.
pub(crate) fn keccakf_1600(a: &mut [u64; A_LEN]) {
